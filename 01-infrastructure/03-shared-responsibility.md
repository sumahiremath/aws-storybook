---
description: "Separate the security and operational responsibilities AWS manages from those the customer must still own."
tags:
  - "aws"
  - "cloud-fundamentals"
  - "architecture"
...
- You still own the code, dependencies, configuration, permissions, data, and application behavior.
...
**Next chapter:** *[Event-Driven Thinking: Stop Hiring People to Wait](04-event-driven-thinking.md)*
