---
description: "Use Amazon Cognito to manage application users, authentication flows, tokens, and federation without rebuilding an identity system."
tags:
  - "aws"
  - "identity-security"
  - "security"
...
# Amazon Cognito: The Tiny Company’s Guest List
...
That distinction matters because real architectures often place several identity tools in the same request path even though they answer different questions.
...
- [User pools and identity pools](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-scenarios.html)
...
**Next chapter:** *[AWS Identity and Access Management: Which Cape Are You Wearing?](02-iam-which-cape-are-you-wearing.md)*
