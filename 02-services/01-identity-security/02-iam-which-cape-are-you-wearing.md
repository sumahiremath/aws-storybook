---
description: "Use AWS IAM identities, roles, policies, and trust relationships to grant only the authority required for a task."
tags:
  - "aws"
  - "identity-security"
  - "security"
...
# AWS Identity and Access Management: Which Cape Are You Wearing?
...
Every diagram made sense until the controls appeared in one real request:
...
The pieces were individually clear. Together, they were difficult to reason about.

The solution was not another diagram. It was one ridiculous question.
...
**Next chapter:** *[AWS Security Token Service: Polyjuice Potion](03-sts-polyjuice-potion.md)*
