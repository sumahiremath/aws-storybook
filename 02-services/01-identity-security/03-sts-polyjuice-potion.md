---
description: "Use AWS STS to obtain temporary credentials for an assumed role without turning that role into a permanent identity."
tags:
  - "aws"
  - "identity-security"
  - "security"
...
# AWS Security Token Service: Polyjuice Potion
...
The useful similarity is expiration: STS credentials are temporary and stop working after the session ends.
...
**Next chapter:** *[AWS Key Management Service: The Elder Wand Answers to Its True Owner](04-kms-elder-wand.md)*
