---
description: "Use AWS KMS keys and policies to control cryptographic operations without treating encryption as automatic permission to decrypt."
tags:
  - "aws"
  - "identity-security"
  - "security"
...
# AWS Key Management Service: The Elder Wand Answers to Its True Owner
...
**Next chapter:** *[AWS Systems Manager Parameter Store: The Filing Cabinet](05-parameterstore-filingcabinet.md)*
