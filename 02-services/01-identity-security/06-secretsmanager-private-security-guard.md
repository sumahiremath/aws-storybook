---
description: "Use AWS Secrets Manager to store, retrieve, and rotate sensitive credentials without embedding them in application configuration."
tags:
  - "aws"
  - "identity-security"
  - "security"
...
# AWS Secrets Manager: The Private Security Guard
...
**Next chapter:** *[AWS WAF: The Front-Door Screen](07-waf-front-door-screen.md)*
