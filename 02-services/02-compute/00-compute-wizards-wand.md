---
description: "Choose AWS compute by matching the service to the workload’s runtime, control, scaling, packaging, and lifecycle needs."
tags:
  - "aws"
  - "compute"
  - "orientation"
...
# AWS Compute: The Wand Chooses the Wizard
...
**Next chapter:** *[Amazon EC2: Bits Boba That Stays Open](01-ec2-boba-shop.md)*
