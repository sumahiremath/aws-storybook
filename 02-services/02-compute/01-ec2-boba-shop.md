---
description: "Amazon EC2 gives your application a provisioned virtual machine that remains available while it is running, whether customers are lining up or nobody walks through the door."
tags:
  - "aws"
  - "compute"
  - "ec2"
...
# Amazon EC2: Bits Boba That Stays Open
...
### Bits Boba That Stays Open

Bits Boba opens at 9 a.m.
...
Not every Bits Boba location needs the same equipment.
...
Before Bits Boba opens, it needs a starting setup:
...
Bits Boba needs rules about who may enter and which doors may be used.
...
Do not lease a full Bits Boba location to make one drink every Thursday.
...
| ----------------------------- | ----------------------- | ----------------------------------------------------------------------------------------------- |
| Permanent Bits Boba location           | EC2 instance            | A provisioned virtual server                                                                    |
...
The Bits Boba location is described as staying open because EC2 represents provisioned compute.
...
**Next chapter:** *[Amazon Machine Image (AMI): Bottle the Shop Setup, Not the Business](02-ami-blueprint.md)*

One Bits Boba location gives you compute.
