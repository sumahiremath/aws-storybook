---
description: "Elastic Load Balancing gives customers one stable front door while routing each request to a healthy backend target — and different kinds of hosts make routing decisions in different ways."
tags:
  - "aws"
  - "compute"
  - "load-balancing"
...
Yesterday, the business had one Bits Boba location.
...
**Next chapter:** *[Containers: The Food Truck That Carries the Kitchen](05-containers-the-food-truck.md)*
