---
description: "Containers package an application with its user-space runtime and dependencies, allowing the workload to run consistently on a compatible host kernel."
tags:
  - "aws"
  - "compute"
  - "concept"
...
> Containers package an application with its user-space runtime and dependencies, allowing the workload to run consistently on a compatible host kernel.

---

## The Business Goal

Your first Bits Boba location is thriving.
...
| Bits Boba | AWS / Containers | Meaning |
|---|---|---|
| Food truck | Container | Portable application package |
| Kitchen equipment | Application + user-space dependencies | The packaged runtime above the shared host kernel |
...
Yesterday, the Bits Boba standardized its permanent shops.
...
**Next chapter:** *[Amazon ECS: The Operations Manager Behind Your Food Truck Festival](06-ecs-operations-manager.md)*
